...
lose_sound = pygame.mixer.Sound('Resources/fail2.wav')
beep_sound=pygame.mixer.Sound('Resources/beep.wav')
...
loading.add.progress_bar("", progressbar_id="1", default=0, width=300, box_progress_color=(250, 72, 93),progress_text_font_color=(8, 3, 4))
