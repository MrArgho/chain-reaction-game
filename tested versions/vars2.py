...
class Spot():
    def __init__(self, i, j):
        ...
        self.neighbors = []
        self.noAtoms = 0
        self.i = i  # Row coordinate
        self.j = j  # Column coordinate
...
def gameOver(playerIndex): 
    ...
    while True:
        ...
        # Create a separate surface to render the text
...
def findBestMove(grid, currentPlayer):
    ...
    bestMove = None
    available_cells = []
    score,bestMove = minimax(gridcopy, 5, float('-inf'), float('inf'),  currentPlayer)
    grid = gridcopy.copy()
    return bestMove
...
# Create a custom theme for the menus
custom_theme = pygame_menu.themes.Theme(
    ...
    widget_padding=(0, 10),
    widget_margin=(0, 25),
    title_font='8-BIT WONDER.TTF',  # Specify the path to your custom title font file
    widget_font='8-BIT WONDER.TTF'  # Specify the path to your custom widget font file
)
...
color = pygame_menu.Menu('Select a Color', 480, 480, theme=custom_theme)
